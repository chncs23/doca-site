...
?>  
<a class="css_menu<?=active_menu("/section_finance.php?menu=1",1)?>" href="section_finance.php">กิจกรรมหน่วย</a> 
<a class="css_menu<?=active_menu("/section_finance.php?menu=2")?>" href="section_finance_mission.php">ภารกิจหน่วย</a>  
<div align="left"><img src="images/dep" width="100%" height="100%"/></div>
   </td>
