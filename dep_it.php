...
?>
<a class="css_menu<?=active_menu("/dep_it.php?menu=1",1)?>" href="dep_it.php">กิจกรรมหน่วย</a>
<a class="css_menu<?=active_menu("/dep_it.php?menu=2")?>" href="dep_it_mission.php">ภารกิจหน่วย</a>
<div align="left"></div>
   </td>
