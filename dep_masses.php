...
?>
<a class="css_menu<?=active_menu("/dep_masses.php?menu=1",1)?>" href="dep_masses.php">กิจกรรมหน่วย</a>
<a class="css_menu<?=active_menu("/dep_masses.php?menu=2")?>" href="dep_masses_mission.php">ภารกิจหน่วย</a>
<div align="left"><img src="images/department_staff/staff_masses.png" width="100%" height="100%"/></div>
   </td>
