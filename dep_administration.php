...
?>
<a class="css_menu<?=active_menu("/dep_administration.php?menu=1",1)?>" href="dep_administration.php">กิจกรรมหน่วย</a>
<a class="css_menu<?=active_menu("/dep_administration.php?menu=2")?>" href="dep_administration_mission.php">ภารกิจหน่วย</a>
<div align="left"><img src="images/dep_administration/administration_staff.jpg" width="100%" height="100%"/></div>
   </td>
