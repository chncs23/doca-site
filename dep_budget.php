...
?>
<a class="css_menu<?=active_menu("/dep_budget.php?menu=1",1)?>" href="dep_budget.php">กิจกรรมหน่วย</a>
<a class="css_menu<?=active_menu("/dep_budget.php?menu=2")?>" href="dep_budget_mission.php">ภารกิจหน่วย</a>
<div align="left"><img src="images/dep_budget/budget_staff.jpg" width="100%" height="100%"/></div>
   </td>
