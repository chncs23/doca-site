...
<tr>
  ...
  <td align="left" valign="top" background="images/baseBG.png">
   <div align="right">
   <a href="#" onClick="window.open('channel-add.php','','width=650,height=400'); return false;" title="Add fft"> 
   <img src="/images/btn-new.png" width="75" height="75"/>
        ...
        <thead> 
        <tr> 
            <th width="50"><span class="style18">VDO</span></th> 
        ...
        <tbody> 
                ...
                require_once("callconnection.php");
                    ...
                    <tr >
                        ...
                        <a href="channel-edit.php?Sendid=<?=$channel_id?>" onClick="window.open('channel-edit.php?Sendid=<?=$channel_id?>','','width=650,height=400'); return false;" title="Add receive">แก้ไข</a></span></td>
                        <td>
                        <span class="style16">
                        
                        <a href="channel-delete.php?Sendid=<?=$channel_id?>" onClick="window.open('channel-delete.php?Sendid=<?=$channel_id?>','','width=250,height=150'); return false;" title="confirm delete">delete
                        </a>             
                        </span>
                        </td>
                    </tr>
