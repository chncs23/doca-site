...
<thead>
<tr>
    <th width="75"><span class="style18">ลำดับที่</span></th>
			...
			require_once("callconnectionimproved.php");
			  ...
			  $total=mysqli_num_rows($objQuery);
				...
				while ($objResult=mysqli_fetch_array($objQuery))
					...
					{
					echo '<tr>';
						echo '<td>'; echo '<span class="style16">'; echo $objResult["receive_id"]; echo '</span>'; echo '</td>';
						echo '<td>'; echo '<span class="style16">'; echo $objResult["receive_date"]; echo '</span>'; echo '</td>';
