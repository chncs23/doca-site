...
<title>..แผนกการเงินและงบประมาณ..</title>
</head>
<body topmargin="">
<div id="fb-root"></div>
...
<tr>
  <td width="250" height="300" align="center" background="/images/baseBG.png"><p><span class="style18">ผู้บังคับบัญชา</strong><br>
    <img src="images/" width="175" height="215" vspace="0" border="0" /><br>
    พ.อ.<br>
    ผอ..กร.ทบ. </span></p>
  </td>
...
?>  
<a class="css_menu<?=active_menu("/section_finance.php?menu=1")?>" href="section_finance.php">กิจกรรมหน่วย</a>
<a class="css_menu<?=active_menu("/section_finance.php?menu=2",1)?>" href="section_finance_mission.php">ภารกิจหน่วย</a>  
<br>
<p class="style18">
1. ดำเนินการ เบิก รับ จ่าย เก็บรักษา และการบัญชีของหน่วยให้เป็นไปตามระเบียบของทางราชการ<br>
2. ให้ข้อเสนอแนะและคำปรึกษาด้านการเงินและการบัญชีแก่ผู้บังคับบัญชา <br>
...
<tr>
  <td width="250" align="left" background="/images/baseBG.png">
  	<p class="style18">Tel : </p>
    <p class="style18">Fax :     </p>
