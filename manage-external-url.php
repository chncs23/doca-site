...
<tr>
  ...
  <td align="left" valign="top" background="images/baseBG.png"><h2>จัดการ URL หน่วยงานอื่น ๆ</h2>
    <div align="right">
      <button
      type="button"
      class="btn btn-primary"
      onClick="window.open('external-url-add.php','','width=1366,height=700'); return false;"
      title="เพิ่ม URL"><span class="glyphicon glyphicon-plus"></span> เพิ่ม URL</button>
    </div>
  </div>
  ...
  $strSQL = "SELECT * FROM external_url WHERE menu_id != '' order by menu_id desc";
...
<tr>
      ...
      <td><span class="style16">
          <a href="external-url-edit.php?Sendid=$menu_id" onClick="window.open('external-url-edit.php?Sendid=$menu_id','','width=650,height=400'); return false;" title="แก้ไขข้อมูล">แก้ไข</a></span></td>
      <td>
          <span>
          <a href="external-url-delete.php?Sendid=$menu_id?" onClick="window.open('external-url-delete.php?Sendid=$menu_id?','','width=250,height=150'); return false;" title="ลบข้อมูล">ลบ</a>
          </span>
      </td>
</tr>
HTML;
