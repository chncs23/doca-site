<?php
	...
	$receiveid = $_GET['Sendid'];
		...
		$strSQL = "SELECT * FROM custom_menu WHERE menu_id like '%".$receiveid."%'";
...
<body>
	<div class="container">
		<p class="style22">แก้ไขเมนู</p>
		<form action="update-custom-menu.php" method="post" enctype="multipart/form-data">
