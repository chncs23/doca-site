...
<tr>
  ...
  <td align="left" valign="top" background="images/baseBG.png">
   <div align="right">
   <a href="#" onClick="window.open('journal-add.php','','width=650,height=400'); return false;" title="Add fft"> 
   <img src="/images/btn-new.png" width="75" height="75"/>
        ...
        <tr> 
            ...
            <th width=""><span class="style18">บทความ</span></th> 
        ...
        <?
                    while($objResult = mysql_fetch_array($objQuery))
                    {
                                    ...
                                    $journal_status  = $objResult['journal_status'];
        ...
        ?>		
                    ...
                    <tr >
                        ...
                        <td ><span class="style16"><?=$journal_status?></span></td>
                        <td ><span class="style16">
                        <a href="journal-edit.php?Sendid=<?=$journal_id?>" onClick="window.open('journal-edit.php?Sendid=<?=$journal_id?>','','width=650,height=400'); return false;" title="Add receive">แก้ไข</a></span></td>
                        <td>
                        <span class="style16">
                        <a href="journal-delete.php?Sendid=<?=$journal_id?>" onClick="window.open('journal-delete.php?Sendid=<?=$journal_id?>','','width=250,height=150'); return false;" title="confirm delete">delete
                        </a>             
                        </span>
                        </td>
                    </tr>
