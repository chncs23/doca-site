...
?>  
<a class="css_menu<?=active_menu("/dep_psycho.php?menu=1",1)?>" href="dep_psycho.php">กิจกรรมหน่วย</a> 
<a class="css_menu<?=active_menu("/dep_psycho.php?menu=2")?>" href="dep_psycho_mission.php">ภารกิจหน่วย</a>  
<div align="left"><img src="images/department_staff/staff_psycho.png" width="100%" height="100%"/></div>
   </td>
